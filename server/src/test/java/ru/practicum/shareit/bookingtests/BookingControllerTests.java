...
import static ru.practicum.shareit.booking.model.StatusType.WAITING;
...
public class BookingControllerTests {
    ...
    void createByWrongUserTest() {
        assertThrows(ModelNotFoundException.class, () -> bookingController.create(bookingInDto, 1L));
    }
    ...
    void approveToWrongBookingTest() {
        assertThrows(ModelNotFoundException.class, () -> bookingController.approve(1L, 1L, true));
    }
    ...
    void approveByWrongUserTest() {
        ...
        UserDto user1 = userController.create(userDto1);
        BookingDto booking = bookingController.create(bookingInDto, user1.getId());
        assertThrows(ModelNotFoundException.class, () -> bookingController.approve(1L, 2L, true));
    }
    ...
    void getAllByWrongUserTest() {
        assertThrows(ModelNotFoundException.class, () -> bookingController.getAllByUser(1L, "ALL", 0, 10));
        assertThrows(ModelNotFoundException.class, () -> bookingController.getAllByOwner(1L, "ALL", 0, 10));
    }

    @Test
    void getByWrongIdTest() {
        assertThrows(ModelNotFoundException.class, () -> bookingController.getById(1L, 1L));
    }
    ...
    void getByWrongUser() {
        ...
        UserDto user1 = userController.create(userDto1);
        BookingDto booking = bookingController.create(bookingInDto, user1.getId());
        assertThrows(ModelNotFoundException.class, () -> bookingController.getById(1L, 10L));
    }
}
