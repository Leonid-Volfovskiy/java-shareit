...
public class ItemControllerTests {
    ...
    void createByWrongUser() {
        assertThrows(ModelNotFoundException.class, () -> itemController.create(1L, itemInDto));
    }
    ...
    void updateForWrongItemTest() {
        assertThrows(ModelNotFoundException.class, () -> itemController.update(1L, 1L, itemInDto));
    }
    ...
    void updateByWrongUserTest() {
        userController.create(userDto);
        itemController.create(1L, itemInDto);
        assertThrows(ItemOwnerException.class, () -> itemController.update(10L, 1L, itemInDto2));
    }
...
/*    @Test
    ...
    void createCommentByWrongUser() {
        assertThrows(ModelNotFoundException.class, () -> itemController.createComment(1L, 1L, comment));
    }
