...
class ItemRequestServiceImplTest {
    ...
    void getAll() {
        List<ItemRequest> itemRequestList = Stream.of(itemRequest1, itemRequest2)
                .filter(Objects::nonNull).collect(Collectors.toList());
        when(userService.getById(anyLong())).thenReturn(userDto1);
        when(itemRequestRepository.findAllByRequestorIdIsNotOrderByCreatedAsc(anyLong(), any(PageRequest.class)))
        ...
        verify(itemRequestRepository, times(1))
                .findAllByRequestorIdIsNotOrderByCreatedAsc(anyLong(), any(PageRequest.class));
    }
