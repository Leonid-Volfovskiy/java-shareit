...
public class ItemRequestControllerTests {
    ...
    void createByWrongUserTest() {
        assertThrows(ModelNotFoundException.class, () -> itemRequestController.create(1L, itemRequestDto));
    }
    ...
    void getAllByUserWithWrongUserTest() {
        assertThrows(ModelNotFoundException.class, () -> itemRequestController.getAllByUser(1L));
    }
    ...
    void getAllByWrongUser() {
        assertThrows(ModelNotFoundException.class, () -> itemRequestController.getAll(0, 10, 1L));
    }
